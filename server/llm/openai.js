...
// - failures surface as LLMError (HTTP 502) with a message safe to show
// - JSON helper for strict structured outputs
...
const models = {
  main: () => process.env.OPENAI_MODEL || 'gpt-5.4',
 ...
 * `input` may be a string or Responses input items.
 */
...
module.exports = { LLMError, createResponse, createJSON, parseJSON, models, redact };
